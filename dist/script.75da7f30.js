...
var HTML = {};
var endPoint = "https://frontendspring20-f2e0.restdb.io/rest/cards";
var APIKey = "5e957b2e436377171a0c2346";
var elements;
...
function formInteractive() {
  ...
  document.querySelector("#inp-deadline").setAttribute("min", (0, _moment.default)().format("YYYY-MM-DD"));
  ...
  elements.deadline.addEventListener("change", function () {
    elements.deadline.classList.remove("placeholder");
    elements.deadline.classList.add("valid");
  });
  elements.deadline.addEventListener("blur", function () {
    if ((0, _moment.default)(elements.deadline.value).isBefore((0, _moment.default)())) {
  ...
  elements.deadline.addEventListener("focus", function () {
    document.querySelector(".deadline-err").style.display = "none";
  });
  ...
  elements.estimate.addEventListener("keyup", function (e) {
  ...
  HTML.form.addEventListener("submit", function (e) {
    e.preventDefault();
    var formValidity = HTML.form.checkValidity();
    ...
    if (formValidity) {
      ...
      if (!elements.title.checkValidity()) {
        ...
        elements.title.addEventListener("focus", function () {
      ...
      if (elements.creator.value === "*") {
        ...
        elements.creator.addEventListener("focus", function () {
      ...
      if (!elements.estimate.checkValidity()) {
        ...
        elements.estimate.addEventListener("focus", function () {
      ...
      if (elements.priority.value === "*") {
        ...
        elements.priority.addEventListener("focus", function () {
...
function deleteIt(id) {
  console.log("DELETING ID: " + id); //Removes it immediately

  document.querySelector("article[data-id=\"".concat(id, "\"]")).remove(); //Removes it from the database
...
function showCard(e) {
  var dest = e.dest;
  var clone = HTML.temp.cloneNode(true).content;
  clone.querySelector(".card").dataset.id = e._id;
  clone.querySelector(".title").textContent = e.title;
  clone.querySelector(".card").style.borderBottom = "5px solid ".concat(e.color); // clone.querySelector(".desc").textContent = e.description;
  ...
  if (dest === "done") {
    ...
    clone.querySelector(".move-left").addEventListener("click", function () {
      updateDest(e, "left");
    });
    ...
    clone.querySelector(".move-right").addEventListener("click", function () {
      updateDest(e, "right");
    });
  } else if (dest === "todo") {
  ...
  clone.querySelector("button.delete-this").addEventListener("click", function () {
    deleteIt(e._id);
  });
  clone.querySelector(".title").addEventListener("click", function () {
    openPopup(e);
  });
  document.querySelector("#".concat(dest, " .cards")).appendChild(clone);
}

function openPopup(e) {
  console.log(e);
  var dateFormatted = formatDate(e);
  ...
  document.querySelector(".popup-deadline p+p span+span").textContent = (0, _moment.default)().to(dateFormatted);
  ...
  document.querySelector(".popup-delete").addEventListener("click", function () {
    document.querySelector(".popup").classList.remove("open_popup");
    deleteIt(e._id);
  });
}
...
function formatDate(e) {
  ...
  return (0, _moment.default)(e.deadline).format("L");
}
